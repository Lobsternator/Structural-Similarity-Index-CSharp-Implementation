...
namespace StructuralSimilarityIndex
{
    class Comparer
    {
        ...
        public Comparer(Bitmap img1, Bitmap img2, int rescaleSize, int windowSize, double k1 = 0.01, double k2 = 0.03)
        {
            this.img1 = img1;
            this.img2 = img2;
        ...
        Bitmap RescaleBitmap(Bitmap bmp)
        {
            ...
            var destBmp = new Bitmap(rescaleSize, rescaleSize, pixelFormat);
